export const typeIdToID = new Map([
	...
	['minecraft:lab_table', -988], //no texture (edu?)
	['minecraft:element_constructor', -987], //no texture (edu?)
	['minecraft:material_reducer', -986], //no texture (edu?)
	['minecraft:underwater_tnt', -985], //shows tnt (edu?)
	...
	['minecraft:colored_torch_purple', -964], // (edu)
	['minecraft:colored_torch_green', -963], // (edu)
	...
	['minecraft:hard_orange_stained_glass', -688], // end of edu n/a
	...
	['minecraft:hard_black_stained_glass_pane', -672], //edu n/a start
	...
	['minecraft:hard_orange_stained_glass_pane', -658], //edu n/a end
	...
	['minecraft:black_candle_cake', -445], // yeah all these are the same
	...
	['minecraft:wierd_soul_campfire', -290], // this is a wierd 3d render of the soul campfire
	['minecraft:crying_obsidian', -289],
	['minecraft:nether_gold_ore', -288],
	['minecraft:twisting_vines', -287],
	['minecraft:chain', -286], // why was this missing huh
	...
	// -238 is nether sprouts... this also shows up around 600ish
	['minecraft:soul_fire', -237], //added
	...
	['minecraft:light_block_0', -215], //wierd placement
	['minecraft:lit_blast_furnace', -214],
	['minecraft:composter', -213],
	['minecraft:oak_wood', -212],
	['minecraft:jigsaw', -211],
	// -210 N/A
	['minecraft:wierd_campfire'], // wierd normal campfire 3d render
	...
	['minecraft:element_1', -12], //edu end?
	...
	['minecraft:element_0', 36], // the `_0` things are always placed wierdly
	...
	['minecraft:wierd_brewing_stand', 117], //looks kinda wierd but i could see use for it
	...
	['minecraft:wierd_flower_pot', 140], //i mean could be used ig
	...
	['minecraft:wierd_cauldron', 154], //wierd cauldron flat texture
	...
	['minecraft:hard_glass_pane', 190], //shows up as a `missing` textured pane block, nice (if not edu prob)
	['minecraft:hard_white_stained_glass_pane', 191], //edu?
	...
	['minecraft:colored_torch_red', 202], // edu?
	['minecraft:purpur_stairs', 203],
	['minecraft:colored_torch_blue', 204], // edu?
	...
	['minecraft:compound_creator', 238], // edu?
	['minecraft:underwater_torch', 239], // edu? missing flat
	...
	['minecraft:glowing_obsidian', 246], // why is it one word?? not removing that tho ig
	['minecraft:netherreactor', 247],
	['minecraft:nether_reactor', 247], // one word again
	['minecraft:info_update', 248], // missing block
	['minecraft:info_update2', 249], // missing block (could be dif?)
	['minecraft:moving_block', 250], // missing flat
	['minecraft:observer', 251],
	['minecraft:structure_block', 252],
	['minecraft:hard_glass', 253], // edu? missing block
	['minecraft:hard_white_stained_glass', 254], // edu?
	['minecraft:reserved6', 255], // ??? missing block
	// 256 N/A (cus its 256 maybe? idk)
	...
	['minecraft:agent_spawn_egg', 514], // no edu required, looks kinda cool
	...
	['minecraft:command_block_minecart', 595], // this LITERALLY DOESNT EXIST // nvm it does
	...
	['minecraft:camera_block', 629], //same as camera but its a different id great game
	['minecraft:compound', 630], // edu?
	['minecraft:ice_bomb', 631], // edu?
	['minecraft:bleach', 632], // edu?
	['minecraft:rapid_fertilizer', 633], // edu?
	['minecraft:balloon', 634], // edu?
	['minecraft:medicine', 635], // edu?
	['minecraft:sparkler', 636], // edu?
	['minecraft:glow_stick', 637], // is it supposed to look like this?
	...
	['minecraft:music_disc_pigstep', 655],
	['minecraft:nether_sprouts', 656],
	['minecraft:soul_campfire', 657],
	['minecraft:glow_frame', 658],
	['minecraft:amethyst_shard', 659],
	['minecraft:spyglass', 660],
	['minecraft:music_disc_otherside', 661],
	['minecraft:goat_horn', 662],
	['minecraft:frog_spawn_egg', 663],
	['minecraft:tadpole_spawn_egg', 664],
	['minecraft:tadpole_bucket', 665],
	['minecraft:allay_spawn_egg', 666],
	['minecraft:warden_spawn_egg', 667],
	['minecraft:mangrove_door', 668],
	['minecraft:mangrove_sign', 669],
	['minecraft:mangrove_boat', 670],
	['minecraft:music_disc_5', 671],
	['minecraft:disc_fragment_5', 672],
	['minecraft:oak_chest_boat', 673],
	['minecraft:birch_chest_boat', 674],
	['minecraft:jungle_chest_boat', 675],
	['minecraft:spruce_chest_boat', 676],
	['minecraft:acacia_chest_boat', 677],
	['minecraft:dark_oak_chest_boat', 678],
	['minecraft:mangrove_chest_boat', 679],
	['minecraft:recovery_compass', 681],
	['minecraft:echo_shard', 682],
	['minecraft:trader_llama_spawn_egg', 683],
	['minecraft:cherry_boat', 684],
	['minecraft:cherry_chest_boat', 685],
	['minecraft:cherry_sign', 686],
	['minecraft:bamboo_sign', 687],
	['minecraft:bamboo_raft', 688],
	['minecraft:bamboo_chest_raft', 689],
	['minecraft:camel_spawn_egg', 690],
	['minecraft:angler_pottery_sherd', 691],
	['minecraft:archer_pottery_sherd', 692],
	['minecraft:arms_up_pottery_sherd', 693],
	['minecraft:blade_pottery_sherd', 694],
	['minecraft:brewer_pottery_sherd', 695],
	['minecraft:burn_pottery_sherd', 696],
	['minecraft:danger_pottery_sherd', 697],
	['minecraft:explorer_pottery_sherd', 698],
	['minecraft:flow_pottery_sherd', 699],
	['minecraft:friend_pottery_sherd', 700],
	['minecraft:guster_pottery_sherd', 701],
	['minecraft:heart_pottery_sherd', 702],
	['minecraft:heartbreak_pottery_sherd', 703],
	['minecraft:howl_pottery_sherd', 704],
	['minecraft:miner_pottery_sherd', 705],
	['minecraft:mourner_pottery_sherd', 706],
	['minecraft:plenty_pottery_sherd', 707],
	['minecraft:prize_pottery_sherd', 708],
	['minecraft:scrape_pottery_sherd', 709],
	['minecraft:sheaf_pottery_sherd', 710],
	['minecraft:shelter_pottery_sherd', 711],
	['minecraft:skull_pottery_sherd', 712],
	['minecraft:snort_pottery_sherd', 713],
	['minecraft:brush', 714],
	['minecraft:netherite_upgrade_smithing_template', 715],
	['minecraft:sentry_armor_trim_smithing_template', 716],
	['minecraft:dune_armor_trim_smithing_template', 717],
	['minecraft:coast_armor_trim_smithing_template', 718],
	['minecraft:wild_armor_trim_smithing_template', 719],
	['minecraft:ward_armor_trim_smithing_template', 720],
	['minecraft:eye_armor_trim_smithing_template', 721],
	['minecraft:vex_armor_trim_smithing_template', 722],
	['minecraft:tide_armor_trim_smithing_template', 723],
	['minecraft:snout_armor_trim_smithing_template', 724],
	['minecraft:rib_armor_trim_smithing_template', 725],
	['minecraft:spire_armor_trim_smithing_template', 726],
	['minecraft:silence_armor_trim_smithing_template', 727],
	['minecraft:wayfinder_armor_trim_smithing_template', 728],
	['minecraft:raiser_armor_trim_smithing_template', 729],
	['minecraft:shaper_armor_trim_smithing_template', 730],
	['minecraft:host_armor_trim_smithing_template', 731],
	['minecraft:flow_armor_trim_smithing_template', 732],
	['minecraft:bolt_armor_trim_smithing_template', 733],
	['minecraft:music_disc_relic', 734],
	['minecraft:skull', 735],
	['minecraft:white_terracotta', 736],
	['minecraft:armadillo_spawn_egg', 737],
	['minecraft:armadillo_scute', 738],
	['minecraft:wolf_armor', 739],
	['minecraft:pale_oak_boat', 740],
	['minecraft:pale_oak_chest_boat', 741],
	['minecraft:pale_oak_sign', 742],
	['minecraft:creaking_spawn_egg', 743],
	['minecraft:resin_brick', 744],
	['minecraft:blue_egg', 745],
	['minecraft:brown_egg', 746],
	['minecraft:happy_ghast_spawn_egg', 747],
	['minecraft:black_harness', 748],
	['minecraft:blue_harness', 749],
	['minecraft:brown_harness', 750],
	['minecraft:cyan_harness', 751],
	['minecraft:gray_harness', 752],
	['minecraft:green_harness', 753],
	['minecraft:light_blue_harness', 754],
	['minecraft:light_gray_harness', 755],
	['minecraft:lime_harness', 756],
	['minecraft:magenta_harness', 757],
	['minecraft:orange_harness', 758],
	['minecraft:pink_harness', 759],
	['minecraft:purple_harness', 760],
	['minecraft:red_harness', 761],
	['minecraft:white_harness', 762],
	['minecraft:yellow_harness', 763],
	['minecraft:copper_golem_spawn_egg', 764], //WHY IS IT OUTTT HEREEE???
	['minecraft:copper_sword', 765],
	['minecraft:copper_shovel', 766],
	['minecraft:copper_pickaxe', 767],
	['minecraft:copper_axe', 768],
	['minecraft:copper_hoe', 769],
	['minecraft:copper_helmet', 770],
	['minecraft:copper_chestplate', 771],
	['minecraft:copper_leggings', 772],
	['minecraft:copper_boots', 773],
	['minecraft:copper_nugget', 774],
	['minecraft:copper_horse_armor', 775], //copper horse armor was missing, shifted ids below this point in this mapping (yay...)
	['minecraft:wool', 776],
	['minecraft:carpet', 777],
	['minecraft:log', 778],
	['minecraft:fence', 779],
	['minecraft:stonebrick', 780],
	['minecraft:coral_block', 781],
	['minecraft:stone_block_slab', 782],
	['minecraft:stone_block_slab2', 783],
	['minecraft:stone_block_slab3', 784],
	['minecraft:stone_block_slab4', 785],
	['minecraft:double_stone_block_slab', 786],
	['minecraft:double_stone_block_slab2', 787],
	['minecraft:double_stone_block_slab3', 788],
	['minecraft:double_stone_block_slab4', 789],
	['minecraft:coral_fan', 790],
	['minecraft:coral_fan_dead', 791],
	['minecraft:sapling', 792],
	['minecraft:leaves', 793],
	['minecraft:leaves2', 794],
	['minecraft:wooden_slab', 795],
	['minecraft:red_flower', 796],
	['minecraft:double_plant', 797],
	['minecraft:double_wooden_slab', 798],
	['minecraft:coral', 799],
	['minecraft:tallgrass', 800],
	['minecraft:log2', 801],
	['minecraft:monster_egg', 802],
	['minecraft:concrete', 803],
	['minecraft:concrete_powder', 804],
	['minecraft:stained_glass', 805],
	['minecraft:stained_glass_pane', 806],
	['minecraft:shulker_box', 807],
	['minecraft:wood', 808],
	['minecraft:music_disc_creator', 809],
	['minecraft:music_disc_creator_music_box', 810],
	['minecraft:music_disc_precipice', 811],
	['minecraft:music_disc_tears', 812],
	['minecraft:music_disc_lava_chicken', 813],
	['minecraft:chemistry_table', 814], // edu? except this one is a missing texture in a wierd shape
	['minecraft:hard_stained_glass', 815], // edu? missing block
	['minecraft:hard_stained_glass_pane', 816], // edu? missing pane
	['minecraft:colored_torch_rg', 817], // edu? missing flat
	['minecraft:colored_torch_bp', 818], // edu? missing flat
	['minecraft:light_block', 819],
	['minecraft:boat', 820],
	['minecraft:dye', 821],
	['minecraft:banner_pattern', 822],
	['minecraft:spawn_egg', 823], //looks like an old chicken spawn egg
	['minecraft:end_crystal', 824],
	['minecraft:glow_berries', 825]
]);
